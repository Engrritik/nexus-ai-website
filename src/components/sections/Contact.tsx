      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-16 max-w-6xl mx-auto items-center">
          ...
          >
            ...
            <p className="text-xl text-[#a0a0a0] mb-10 leading-[1.7] font-inter">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4 text-gray-300">
                ...
                <div>
                  ...
                  <a href="mailto:ritikksaklani@gmail.com" className="text-lg hover:text-white transition-colors font-inter">
              ...
              <form action="https://formspree.io/f/myknoypk" method="POST" className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0 }} className="space-y-2">
                    ...
                    <input name="name" required type="text" id="name" className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-teal/50 transition-all placeholder:text-gray-600 font-inter" placeholder="Dr. John Smith" />
                  </motion.div>
                  <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.08 }} className="space-y-2">
                    ...
                    <input name="clinic" required type="text" id="clinic" className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-teal/50 transition-all placeholder:text-gray-600 font-inter" placeholder="Smile Dental" />
                  </motion.div>
                </div>
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.16 }} className="space-y-2">
                  ...
                  <input name="email" required type="email" id="email" className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-teal/50 transition-all placeholder:text-gray-600 font-inter" placeholder="john@smiledental.com" />
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.24 }} className="space-y-2">
                  ...
                  <input name="phone" required type="tel" id="phone" className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-teal/50 transition-all placeholder:text-gray-600 font-inter" placeholder="(555) 123-4567" />
                </motion.div>

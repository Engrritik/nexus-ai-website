  ...
  return (
    <footer className="relative bg-white border-t border-[#f0f0f0] overflow-hidden py-16 md:py-24">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none overflow-hidden z-0">
        <span className="text-[#f8f8f8] font-bold tracking-tighter whitespace-nowrap" style={{ fontSize: 'min(24vw, 350px)', lineHeight: 1 }}>
          NexusAI
        </span>
      </div>
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex items-center gap-8">
            ...
            <Link
              href="#contact"
              className="inline-flex items-center gap-2 bg-[#111111] text-white px-6 py-3 rounded-full text-xs font-semibold tracking-wide uppercase hover:bg-black transition-colors"
            >
              Book a Call <span className="tracking-widest opacity-60">•••</span>
            </Link>
          </div>
